...
export const zhOnePage: OnePageResume = {
  ...
  experience: [
    ...
    },
    {
      ...
      role: '后端工程师 · IT 技术部',
      date: '2023.08 – 2025.05',
      stack: 'Java、SpringBoot、MyBatis、MySQL、分布式事务、Floyd-Warshall、RBAC / ABAC、SonarQube',
      bullets: [
        '**自建 WMS**：主导从开源 ERP [Odoo](https://www.odoo.com/) 迁移到自研 WMS，日均 **3 万+** 仓储作业；设计全链路数据模型与分布式事务一致性',
        '**核心算法与系统集成**：基于 Floyd-Warshall 的拣货路径引擎，5000+ 库位毫秒级调度，平均路径缩短 **37%**；设计与德国站点仓储机器人的跨系统调度接口',
        '**权限、审计与性能**：重构 RBAC + ABAC 鉴权与审计日志，支撑德勤 IPO 审计；慢 SQL 治理使关键响应 **3.2s → 0.8s**',
      ],
    },
    {
      company: '腾讯科技（深圳）有限公司',
...
export const enOnePage: OnePageResume = {
  ...
  experience: [
    ...
    },
    {
      ...
      date: 'Aug 2023 – May 2025',
      stack: 'Java, SpringBoot, MyBatis, MySQL, distributed transactions, Floyd-Warshall, RBAC / ABAC, SonarQube',
      bullets: [
        '**Self-built WMS**: led the migration from open-source ERP [Odoo](https://www.odoo.com/) to an in-house WMS running **30K+** daily operations, with distributed-transaction consistency',
        '**Algorithms & integration**: Floyd-Warshall picking engine over 5,000+ locations cut average paths by **37%**; built the robot scheduling interface for the German site',
        '**Audit & performance**: RBAC + ABAC and audit logging for the Deloitte IPO audit; slow-SQL fixes cut response time **3.2s → 0.8s**',
      ],
    },
    {
      company: 'Tencent Technology (Shenzhen) Co., Ltd.',
